...
#    x_chr = np.load(var[2]+chrom+'.npy').astype('float32') # PAR ChIP
#    y_chr = np.load(var[4]+chrom+'.npy').astype('intc') # RChIP
...
#gc_abun['par_n_rchip.par_atmi.global_gc.u'] = bins[:,1]
##gc_abun['par_n_rchip.par_atmi.global_gc.s'] = bins[:,2]
##gc_abun['par_n_rchip.par_atmi.global_gc.m'] = bins[:,3]
##gc_abun['par_n_rchip.par_atmi.global_gc.X'] = bins[:,4]
#gc_abun['par_n_rchip.rchip_atmi.global_gc.u'] = bins[:,2]
##gc_abun['par_n_rchip.rchip_atmi.global_gc.s'] = bins[:,6]
##gc_abun['par_n_rchip.rchip_atmi.global_gc.m'] = bins[:,7]
##gc_abun['par_n_rchip.rchip_atmi.global_gc.X'] = bins[:,8]
#gc_abun.to_csv('./outputs/rchip_n_par/par_n_rchip.atmi.gc.figures.100K.NAs.txt',sep='\t',index=False)
#gc_abun.dropna().to_csv('./outputs/rchip_n_par/par_n_rchip.atmi.gc.figures.100K.txt',sep='\t',index=False)
...
gc_abun['par_n_rchipC.par_atmi.global_gc.u'] = bins[:,1]
#gc_abun['par_n_rchipC.par_atmi.global_gc.s'] = bins[:,2]
#gc_abun['par_n_rchipC.par_atmi.global_gc.m'] = bins[:,3]
#gc_abun['par_n_rchipC.par_atmi.global_gc.X'] = bins[:,4]
gc_abun.to_csv('./outputs/rchip_n_par/par_n_rchipC.atmi.gc.figures.1mil.NAs.txt',sep='\t',index=False)
gc_abun.dropna().to_csv('./outputs/rchip_n_par/par_n_rchipC.atmi.gc.figures.1mil.txt',sep='\t',index=False)
...
#for chrom in chrs:
#    z_chr = np.load(var[0]+chrom+'.npy').astype('float32') # GC
#    x_chr = np.load(var[4]+chrom+'.npy').astype('float32') # RChIP
#    y_chr = np.load(var[2]+chrom+'.npy').astype('intc') # PAR
#    locs = np.where((y_chr==0) & (x_chr>0))
#    z_chr = z_chr[locs]
#    x_chr = x_chr[locs]
#    del locs,y_chr
...
#gc_abun['rchip_n_parC.rchip_atmi.global_gc.u'] = bins[:,1]
##gc_abun['rchip_n_parC.rchip_atmi.global_gc.s'] = bins[:,2]
##gc_abun['rchip_n_parC.rchip_atmi.global_gc.m'] = bins[:,3]
##gc_abun['rchip_n_parC.rchip_atmi.global_gc.X'] = bins[:,4]
#gc_abun.to_csv('./outputs/rchip_n_par/rchip_n_parC.atmi.gc.figures.1mil.NAs.txt',sep='\t',index=False)
#gc_abun.dropna().to_csv('./outputs/rchip_n_par/rchip_n_parC.atmi.gc.figures.1mil.txt',sep='\t',index=False)
