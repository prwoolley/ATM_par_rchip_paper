...
#    gc_abun[x_name+'global_gc.X'] = bins[:,4]
    gc_abun.to_csv('./outputs/global_gc/'+x_name+'global_gc.15mil.NAs.txt',sep='\t',index=False)
    gc_abun.dropna().to_csv('./outputs/global_gc/'+x_name+'global_gc.15mil.txt',sep='\t',index=False)
